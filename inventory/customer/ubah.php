                      ...
                      <form action="" method ="post" enctype="multipart/form-data" class="row g-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col mb-2">
                                ...
                                <input class="form-control" type="text" placeholder="e.g : +6281000000" name="notelp" id="notelp" required autocomplete ="off" value = "<?= texttonumb(decrypt($ganti["notelp"]))?>">  
                            </div>
                        </div>
                        <div class="mb-2">
                          <label for="alamat">Alamat</label>
                          <textarea class="form-control" name="alamat" id="alamat" style="height: 7rem"><?= decrypt($ganti["alamat"])?></textarea>
                        </div>
