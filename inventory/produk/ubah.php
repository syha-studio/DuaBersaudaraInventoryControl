...
$id = $_GET["id"];
$ganti  = query("SELECT p.id id, p.kategori_ID kid, k.nama kategori, p.nama nama, harga, deskripsi, jumlah FROM produk p
...
<html lang="en">
  <head>
    ...
    <title>Edit Produk | DB-Inventory Control</title>
                        ...
                        <div class="row">
                          <div class="col mb-2">
                            ...
                            <select class="form-select" name="kategori" id="kategori" required>
                              <option selected value="<?= $ganti["kid"]?>"><?= decrypt($ganti["kategori"])?></option>
                            <?php foreach ($kategori as $pro) : ?>
                              <option value="<?=$pro['id']?>"><?=decrypt($pro['nama'])?></option>
                            <?php endforeach?>
                            </select>
                          </div>
                          <div class="col mb-2">
                            <label for="nama" class="form-label">Nama</label>
                            <input class="form-control" type="text" name="nama" id="nama" required autocomplete ="off" value = "<?= decrypt($ganti["nama"])?>">  
                          </div>
                        </div>
                        <div class="row">
                          <div class="col">
                            ...
                            <div class="mb-2">
                              ...
                              <input class="form-control" type="text" name="harga" id="harga" required autocomplete ="off" value = "<?= $ganti["harga"]?>">  
                            </div>
                          </div>
                          <div class="col mb-2">
                            <label for="deskripsi">Deskripsi</label>
                            <textarea class="form-control" name="deskripsi" id="deskripsi" style="height: 7rem"><?= decrypt($ganti["deskripsi"])?></textarea>
                          </div>
                        </div>
