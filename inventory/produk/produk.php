...
// Query
    $Produk = query("SELECT p.id id, k.nama kategori, p.nama nama, jumlah, harga, deskripsi FROM produk p
...
<head>
    ...
    <title>Produk | DB-Inventory Control</title>
                ...
                <!-- Content Row -->
                    ...
                    <!-- Pencarian -->
                        ...
                        <div class="col-md-auto ps-3">
                            <a href="tambah.php"><button type="button" class="btn btn-primary me-4">Tambah Produk <i class="bi bi-plus-lg"></i></button></a>
                        </div>
                    </div>
                <!-- Content Row -->
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-10">
                            <div class="card shadow mb-4">
                                ...
                                <div class="d-flex justify-content-center p-2 pb-2 overflow-y-scroll" style="max-height: 20rem;">
                                    ...
                                    <tr>
                                        <td><?= $row["id"]?></td>
                                        <td><?= decrypt($row["kategori"])?></td>
                                        <td><?= decrypt($row["nama"])?></td>
                                        <td><?= number_format($row["jumlah"], 0, ',', ' ')?></td>
                                        <td><?= number_format($row["harga"], 2, ',', ' ')?></td>
                                        <td><?= decrypt($row["deskripsi"])?></td>
                                        <td class="">
